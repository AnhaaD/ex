...
class OpenOrders extends React.Component<OpenOrdersProps> {
    ...
    public renderCancelButton = (index: number) => {
        return <CloseButton onClick={this.handleCancel(index)} label={this.props.label} className={this.props.className}/>;
    };
...
// WEBPACK FOOTER //
// src/drone/src/src/custom/components/OpenOrders/index.tsx

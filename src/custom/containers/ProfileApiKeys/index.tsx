...
class ProfileApiKeysComponent extends React.Component<Props, ProfileApiKeysState> {
            ...
            <div className="pg-profile-page__api-keys">
                <div className="pg-profile-page-header">
                    <div className="pg-profile-page__api-keys__header">
                        <h2><b>{this.t('page.body.profile.apiKeys.header')}</b></h2>
                        {user.otp && dataLoaded && (
                            <Button
                                className="pg-profile-page__btn-secondary-change"
                                onClick={this.handleCreateKeyClick}
                                label={this.t('page.body.profile.apiKeys.header.create')}
                            />)}
                    </div>
                </div>
                ...
                {user.otp && !dataLoaded && (
                    <div className="pg-profile-page__text-center">
                        <div className="cr-button pg-profile-page__btn-secondary-change" onClick={this.handleGetKeysClick}>
                            <span>Show</span>
                        </div>
                    </div>
                )}
    ...
    private renderModalBody = () => {
        ...
        const emailGroupClass = cr('cr-email-form__group pg-profile-page__modal-apiKeys', {
...
// WEBPACK FOOTER //
// src/drone/src/src/custom/containers/ProfileApiKeys/index.tsx

...
class DocumentsComponent extends React.Component<Props, DocumentsState> {
                ...
                <div className="pg-confirm__content-documents">
                    <div className="pg-confirm__content-documents-col-row">
                        <div className="pg-confirm__content-documents-col">
                            <div className="pg-confirm__content-documents-col-row">
                                <div className="pg-confirm__content-documents-col-text">
                                    <FormattedMessage id={'page.body.kyc.documents.idType'}/>
                                </div>
                                <div className="pg-confirm__content-documents-col-row-content-3">
                                    <Dropdown
                                        ...
                                        list={this.data}
                                        onSelect={onSelect}
                                        placeholder={this.translate('page.body.kyc.documents.selectIdType')}
                                    />
                                </div>
                                <div className="pg-confirm__content-documents-col-text">
                                    <FormattedMessage id={'page.body.kyc.documents.idNumber'}/>
                                </div>
                                ...
                                <div className="pg-confirm__content-documents-col-text">
                                    <FormattedMessage id={'page.body.kyc.documents.expiryDate'}/>
                                </div>
                                <fieldset className={expirationFocusedClass}>
                                    <MaskInput
                                      ...
                                      placeholder={this.translate('page.body.kyc.documents.dateType')}
                                    />
                                </fieldset>
                            </div>
                        </div>
                                        ...
                                        >
                                            ...
                                            <div className="pg-confirm__content-documents-col-row-content-2-documents-label">
                                                ...
                                                >
                                                    ...
                                                    <div className="muted"><p><FormattedMessage id={'page.body.kyc.documents.maxFile'}/></p></div>
                                                    <div className="muted"><p><FormattedMessage id={'page.body.kyc.documents.maxNum'}/></p></div>
                                                </label>
                                            </div>
                                        </form>
                                    </div>
    ...
    private handleUploadScan = uploadEvent => {
      ...
      const additionalFileList = Array.from(allFiles).slice(0, 5 - oldFileList.length);
...
// WEBPACK FOOTER //
// src/drone/src/src/custom/containers/Confirm/Documents/index.tsx

...
export const estimateWithMarket = (targetCurrency: string, walletCurrency: string, walletTotal: number, currencies: Currency[], markets: Market[], marketTickers: MarketTicker): number => {
    ...
    const targetCurrencyPrecision = handleCCYPrecision(currencies, formattedTargetCurrency, 4);
...
export const estimateWithoutMarket = (targetCurrency: string, walletCurrency: string, walletTotal: number, currencies: Currency[], markets: Market[], marketTickers: MarketTicker): number => {
...
// WEBPACK FOOTER //
// src/drone/src/src/custom/helpers/estimateValue.ts

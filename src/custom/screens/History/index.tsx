...
import { HistoryElement } from '../../../custom/containers/HistoryElement';
...
class History extends React.Component<Props, State> {
    ...
    private renderTabs = () => {
        ...
        return [
            {
                content: tab === 'deposits' ? <HistoryElement type="deposits" className="deposits" /> : null,
                label: this.props.intl.formatMessage({id: 'page.body.history.deposit'}),
            },
            {
                content: tab === 'withdraws' ? <HistoryElement type="withdraws" className="withdraws" /> : null,
                label: this.props.intl.formatMessage({id: 'page.body.history.withdraw'}),
            },
            {
                content: tab === 'trades' ? <HistoryElement type="trades" className="trades" /> : null,
...
// WEBPACK FOOTER //
// src/drone/src/src/custom/screens/History/index.tsx

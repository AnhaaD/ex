    ...
    private renderSignInForm = () => {
        ...
        return (
            <SignInComponent
                ...
                siteKey={siteKey()}
                recaptchaOnChange={this.handleCheckRecaptcha}
                recaptchaChecked={recaptchaChecked}
            />
        );
    };

    private handleCheckRecaptcha = () => {
        this.setState({
...
const SignInScreen = injectIntl(withRouter(connect(mapStateToProps, mapDispatchProps)(SignIn) as any));
...
// WEBPACK FOOTER //
// src/drone/src/src/custom/screens/SignInScreen/index.tsx
